      ...
      <div class="col px-5 position-relative d-flex align-items-center">
        <div class="row justify-content-center w-100">
          <div class="col-md-12 col-lg-12 col-xl-6">
            <div class="decoration-check mb-2">
            ...
            <div class="text-center mb-2">
                <h2 class="mb-0"><?php echo $_SESSION['fname']; ?> is Verified!</h2>
                <span>Find your details and Reg No below.</span>
                ...
                <div class="col-12 col-md-12 pt-2">
                    ...
                    <h4 class="mb-0">Audition City</h4>
                    <label class="font-20 text-dark" for="fname" style="font-size: strong;"><?php echo $_SESSION['city'] ?></span></label>
                </div>
            </div>
            <div class="text-center">
              <span>Go to main site <a href="\" class="hover-arrow">Exit</a>
              </span>
            </div>
          </div>
        </div>
